        ...
        children: [
          ...
          Padding(
            ...
            child: ClipRRect(
              ...
              child: NetworkOrAssetLatestNews.networkOrAssetLatestNews(
                  newsEntity,
              ),
            ),
          ),
          ...
          const SizedBox(height: 5),
          Text(
            newsEntity.published.replaceRange(19, null, ''), //TODO будет ошибка при нормальной дате
