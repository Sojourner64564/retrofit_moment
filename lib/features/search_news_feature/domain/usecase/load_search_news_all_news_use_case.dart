...
@injectable
class LoadSearchNewsAllNewsUseCase implements UseCase<List<SearchNewsDataModel>,LoadAllNewsParams>{
  LoadSearchNewsAllNewsUseCase(this.searchNewsRepository);
  final SearchNewsRepository searchNewsRepository;
  @override
  Future<Either<Failure, List<SearchNewsDataModel>>> call(LoadAllNewsParams params) {
    return searchNewsRepository.loadSearchNewsAllNews(params);
  }
